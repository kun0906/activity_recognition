...
class rgb_resneXt3D64f101(nn.Module):
    def __init__(self, num_classes, length, modelPath=''):
        ...
        self.features = nn.Sequential(
            *list(_trained_resnext101(model_path=modelPath, sample_size=112, sample_duration=64).children())[:-1])
...
class flow_resneXt3D64f101(nn.Module):
    def __init__(self, num_classes, length, modelPath=''):
        ...
        self.features = nn.Sequential(*list(_trained_resnext101_flow(model_path_flow=modelPath, \
                                                                     sample_size=112, sample_duration=64).children())[
                                       :-1])
...
class rgb_resneXt3D64f101_bert10_FRAB(nn.Module):
    def __init__(self, num_classes, length, modelPath=''):
        ...
        self.features = nn.Sequential(
            *list(_trained_resnext101(model_path=modelPath, sample_size=112, sample_duration=64).children())[:-2])
        ...
        self.bert = BERT5(self.hidden_size, 4, hidden=self.hidden_size, n_layers=self.n_layers,

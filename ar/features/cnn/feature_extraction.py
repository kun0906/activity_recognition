...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--network', type=str, required=True, default='vgg',
                        help='Name of the network')
    parser.add_argument('-f', '--framework', type=str, required=True, default='tensorflow',
                        help='Framework to be used. Options: \'caffe\' or \'tensorflow\'')
    parser.add_argument('-o', '--output_path', type=str, required=True, default='out',
                        help='Output directory where the generated files will be stored')
    parser.add_argument('-v', '--video_list', type=str, default=['data/play_music_1_1615410036_1.mp4'],
